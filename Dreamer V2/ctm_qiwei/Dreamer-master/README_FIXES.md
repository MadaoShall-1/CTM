...
Historical notes from before `move_turn_autopickup_v3`. The current build has
only MOVE/TURN and automatic relay pickup; use README_MIGRATION.md for current
action, observation and reward contracts. This document is not current-run
validation.
